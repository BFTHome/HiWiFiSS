$(function () {
    ...
    function get_ss_config(choice) {
        ...
        $.post('tonycn/ss_ajax', request_data, function(data){
    ...
    function get_ss_status(formdata_refresh) {
        $.post('tonycn/ss_ajax', {'act': 'status'}, function(data){
    ...
    function get_ss_version() {
        $.post('tonycn/ss_ajax', {'act': 'version'}, function(data){
    ...
    function get_domain_force() {
        $.post('tonycn/ss_ajax', {'act': 'domain_force'}, function(data){
    ...
    function get_domain_ignore() {
        $.post('tonycn/ss_ajax', {'act': 'domain_ignore'}, function(data){
    ...
    function get_ipsrc_force() {
        $.post('tonycn/ss_ajax', {'act': 'ipsrc_force'}, function(data){
    ...
    function get_ipdst_force() {
        $.post('tonycn/ss_ajax', {'act': 'ipdst_force'}, function(data){
    ...
    function get_ipsrc_ignore() {
        $.post('tonycn/ss_ajax', {'act': 'ipsrc_ignore'}, function(data){
    ...
    function get_ipdst_ignore() {
        $.post('tonycn/ss_ajax', {'act': 'ipdst_ignore'}, function(data){
    ...
    function get_mac_ignore() {
        $.post('tonycn/ss_ajax', {'act': 'mac_ignore'}, function(data){
    ...
    $('#network_test').on('click', function(){
    	...
    	$.post('tonycn/ss_ajax', {'act': 'network_test'}, function(data){
